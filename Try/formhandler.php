...
//Create header that puts domain-based email in From box, user's email in Reply-To, and name in parentheses
$from='From: '. "mail@ravengildea.atwebpages.com" . "(" . $name . ")" . "\r\n" . 'Reply-To: '. $email . "(" . $name . ")" . "\r\n"; 
// replace name@sitedomain.com with a domain-based email address (the domain the form page is on). It doesn't have to be a real address: it just has to be @ the same domain as the form page.
	
//Creates intelligible subject line that shows where it came from
$subject = 'Email from ravengildea.atwebpages.com'; // put the site name or url here.
...
//Replace clientname@domain.com with your client's email address. Put your own address here for initial testing, put your client's address for final testing and use.
//mail ('clientname@domain.com', $subject, $body, $from);
mail ('ravengildea@gmail.com', $subject, $body, $from);

header('Location: thanks.php'); // replace "thanks.html" with the name and path to your actual thank you page
